    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true) { // server always run
                ...
                // change to string
                String send = String.valueOf(result);
            ...
            Logger.getLogger(Server_MiniCalc.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
